  ...
  <tr>
    ...
    <td class="main" valign="top">
      <table style="width: 100%; valign:top" border="0">
        ...
        <tr>
         <td>Sehr geehrter Anwender, <br> Leider konnte die Bestellung nicht korrekt ausgeführt werden. Bitte setzen Sie sich mit unseren Mitarbeitern in Verbindung, um diese Problem lösen zu können!<br> Mit freundlichen Grüßen <br> Das Hipster Rental Team</td>
        </tr>
      </table>
    </td>
